...
contract('DappTokenSale', function(accounts) {
    ...
    //     // Then grab token sale  return DappToken.deployed().then(function(instance) {
    //     // Grab token instance first
    //     tokenInstance = instance;
    //     return DappTokenSale.deployed();
    //   }) 
    ...
    //     return tokenSaleInstance.bal.call()
    //   })
    //   .then((a) => {
    //       console.log(a)
...
//         return DappTokenSale.deployed();
//     })
//     //.then((d) => {dappTokenSale = d; return dappToken.approve(dappTokenSale.address,750000,{from:accounts[0]})})
//     .then((a) => a.allowance.call())
//     .then(console.log)
